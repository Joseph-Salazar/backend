...
public class MainContext : DbContext
{
    ...
    public DbSet<SavedJobOffers> SavedJobOffers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new JobLabelConfig());
        builder.ApplyConfiguration(new JobOfferConfig());
        builder.ApplyConfiguration(new PostulantConfig());
        builder.ApplyConfiguration(new PostulationConfig());
        builder.ApplyConfiguration(new RoleConfig());
        builder.ApplyConfiguration(new SavedJobOffersConfig());
    }
